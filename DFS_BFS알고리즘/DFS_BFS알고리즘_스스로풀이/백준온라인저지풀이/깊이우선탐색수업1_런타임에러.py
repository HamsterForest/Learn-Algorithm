"""
백준 24479
오늘도 서준이는 깊이 우선 탐색(DFS) 수업 조교를 하고 있다. 아빠가 수업한 내용을 학생들이 
...
visited=[False]*(n+1) #여기에 방문했나요 안했나요
whenv=[0 for _ in range(n+1)]#여기에 몇번째로 온건가요, 방문한적 없으면 디폴트 0
